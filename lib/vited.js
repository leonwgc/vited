...
var run = function run(isDev, options, callback) {
  ...
  var config = __assign(__assign(__assign({}, defaultConfig), options), {
    css: css
  });
  ...
  if (isDev) {
    ...
    (function () {
      return __awaiter(void 0, void 0, void 0, function () {
        var server, port, serveUrl, serverUrlIp;
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 2:
              ...
              serverUrlIp = "http://" + _address.default.ip() + ":" + port;
              console.log();
              console.log(_chalk.default.cyan('dev server running at:'));
              console.log();
              console.log('> Local:', _chalk.default.green("" + serveUrl));
              console.log();
              console.log('> Network:', _chalk.default.green("" + serverUrlIp));
              return [2
              /*return*/
              ];
          }
